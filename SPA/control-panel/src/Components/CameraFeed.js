	...
	if (isRight) {
		return (
			<div>
				...
				<div className="CamPanel">
					<iframe className="CamFrame CamRight" height="640" width="480" style={{zIndex:3}} src="/cam-api/cam0/">
					</iframe>
		...
		return (
			<div>
				...
				<div className="CamPanel">
					<iframe className="CamFrame CamLeft" height="640" width="480" style={{zIndex:3}} src="/cam-api/cam1/">
					</iframe>
					<img src={cross} className="CamCrosshair" />
				</div>
			</div>
